...
| Ветка | `main` |
| Версия | 4.0.0 |
| Фокус | Phase 1 Trust & Polish — VDS deploy, smoke agent-preview, E2E landing flow |
| Документация | Синхронизирована с v4 (2026-06-14): ARCHITECTURE, PROJECT_GUIDE, DEPLOYMENT, SERVER, BRAND, docs/README |
...
4. **Backlog PR** — закрыть выбранные OPEN из TROUBLES (H13, H9) отдельными PR, не блокируя релиз.
