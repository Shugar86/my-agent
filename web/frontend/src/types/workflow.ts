...
export const NODE_TYPES = [
  ...
  { type: 'trigger.email', label: 'Email', category: 'trigger', color: '#238636', icon: 'EM', paletteHidden: true },
  { type: 'trigger.new_lead', label: 'New Lead', category: 'trigger', color: '#238636', icon: 'LD', paletteHidden: true },
