...
| Fallback | NeuroAPI / Kimi — через профили в `core/configurator.py` |
...
python agent.py chat --model balanced   # OpenRouter primary (~6s)
...
Глобальный default: `config/agent.json`.
...
| Postgres sessions error | См. [TROUBLESHOOTING.md](TROUBLESHOOTING.md) §1.1 (исправлено в 3.5.2) |
...
- [WINDOWS_LAUNCH.md](WINDOWS_LAUNCH.md) — Windows CLI
