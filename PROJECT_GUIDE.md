...
| Опционально | Kimi Code API (`KIMI_API_KEY`), NeuroAPI (`NEUROAPI_API_KEY`) |
...
Windows CLI: [WINDOWS_LAUNCH.md](WINDOWS_LAUNCH.md).
...
python agent.py chat --model balanced   # OpenRouter (по умолчанию)
