...
| Опционально | Kimi Code API (`KIMI_API_KEY`, профили в `config/models.yaml`) |
...
Universal подключает большинство skills; остальные — узкоспециализированные.
