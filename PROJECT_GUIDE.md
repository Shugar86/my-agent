...
**My Agent** — AI Agent OS: multi-agent чат, визуальный workflow builder, marketplace шаблонов и public agent preview на лендинге.

| Компонент | Значение |
|-----------|----------|
| Primary LLM | OpenRouter (`OPENROUTER_API_KEY`), профиль `balanced` |
...
Agents, Knowledge и MCP — вкладки в Settings (`?tab=agents|knowledge|mcp`).
