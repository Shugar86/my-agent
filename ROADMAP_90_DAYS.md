...
> **Архив (May 2026).** Актуальный индекс документации: [docs/README.md](docs/README.md).  
> Текущее планирование: [.planning/](.planning/). UI — React `/showcase`, не `website/showcase.html`.
