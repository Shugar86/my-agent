...
> **Архив.** Roadmap завершён в May 2026. Актуальное состояние продукта — [HANDOFF.md](HANDOFF.md) и [CHANGELOG.md](CHANGELOG.md).
...
- React: `web/frontend/src/pages/PublicShowcasePage.tsx`, `ShowcasePage.tsx`
