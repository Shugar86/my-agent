...
| **Документация** | [docs/README.md](docs/README.md) — индекс (обновлён 2026-06-01) |
...
```bash
cp .env.example .env
# Для live chat/demo: OPENROUTER_API_KEY (+ TAVILY_API_KEY для поиска)
# Demo работает и без ключей (mock)
...
| `KIMI_API_KEY` | Опционально: Kimi для отдельных агентов |
| `TAVILY_API_KEY` | Веб-поиск в live demo/chat |
