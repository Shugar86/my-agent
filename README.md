...
- 🧰 **33+ навыков** — research, browser, RAG, документы, презентации, планировщик, выполнение кода, OCR, vision, email, RSS и другие.
...
| Дорожная карта | [ROADMAP_90_DAYS.md](./ROADMAP_90_DAYS.md) |
