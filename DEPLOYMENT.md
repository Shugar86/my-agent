...
# TAVILY_API_KEY=tvly-...          (optional, live web search in demo)
...
- 2 GB RAM minimum
- `OPENROUTER_API_KEY` для live-чата и реальных demo-run (без ключей — mock replay)
...
| `TAVILY_API_KEY` | Web search (demo/research) |
