...
```bash
cp .env.example .env
# OPENROUTER_API_KEY=sk-or-v1-...  (primary LLM для live-чата)
# TAVILY_API_KEY=...  (опционально — веб-поиск в demo)
...
- 2 GB RAM minimum
- `OPENROUTER_API_KEY` (live-чат; demo работает без ключей — mock)
